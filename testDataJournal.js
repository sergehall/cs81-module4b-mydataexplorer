...
const weekData = [
  ...
  { day: "Tuesday", sleepHours: 7.2, screenTime: 4.5, mood: "productive", caffeineIntake: 2, focusLevel: 8 },
  { day: "Wednesday", sleepHours: 6.8, screenTime: 7, mood: "stressed", caffeineIntake: 3, focusLevel: 6 },
  { day: "Thursday", sleepHours: 8.1, screenTime: 4, mood: "calm", caffeineIntake: 2, focusLevel: 7 },
  { day: "Friday", sleepHours: 5.9, screenTime: 6.5, mood: "energetic", caffeineIntake: 4, focusLevel: 6 },
  { day: "Saturday", sleepHours: 9.0, screenTime: 8, mood: "relaxed", caffeineIntake: 1, focusLevel: 9 },
  { day: "Sunday", sleepHours: 7.5, screenTime: 3, mood: "reflective", caffeineIntake: 3, focusLevel: 8 }
];
...
console.log("   Average Caffeine Intake:", caffeineResult.avgCaffeine.toFixed(2));
console.log("   Focus (High Caffeine Days):", caffeineResult.highAvgFocus.toFixed(2));
console.log("   Focus (Low Caffeine Days):", caffeineResult.lowAvgFocus.toFixed(2));
