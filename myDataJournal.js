...
const weekData = [
  ...
  { day: "Thursday", sleepHours: 8.1, screenTime: 4, mood: "calm", caffeineIntake: 1, focusLevel: 7 },
  { day: "Friday", sleepHours: 5.9, screenTime: 6.5, mood: "energetic", caffeineIntake: 4, focusLevel: 6 },
  { day: "Saturday", sleepHours: 9.0, screenTime: 8, mood: "relaxed", caffeineIntake: 0, focusLevel: 9 },
  { day: "Sunday", sleepHours: 7.5, screenTime: 3, mood: "reflective", caffeineIntake: 1, focusLevel: 8 }
];
...
function bestSleepDay(data) {
  return data.reduce((best, cur) => cur.sleepHours > best.sleepHours ? cur : best).day;
}
